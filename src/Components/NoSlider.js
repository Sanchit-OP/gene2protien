...
function NoSlider() {
    return (
        <div className=" h-full   p-[1%] pl-[3%] " style={{backgroundColor: "#28A282"}}>
            <h1 className= " headingssm  md:headings p-2 mb:p-0">
                Highlights
            </h1>
